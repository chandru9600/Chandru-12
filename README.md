...
<head>
    ...
    <title>chandrasekar J - Portfolio</title>
    <style>
        body {
...
<body>
    ...
    <header>
        ...
        <img src="/storage/emulated/0/Pictures/Screenshots/Screenshot_20250401_093910.jpg" alt="chandrasekar J" class="profile-picture">
        <div class="header-content">
            <h1>chandrasekar J</h1>
    ...
    <section id="resume">
        <div class="section-content" style="text-align: center;">
            ...
            <a href="/storage/emulated/0/Download/Resume.pdf" class="download-button">Download CV</a>
        </div>
    </section>
    ...
    <section id="contact">
        <div class="section-content">
            <h2>Contact Me</h2>
            <p>Email: <a href="chandrasekar J ">cs2301111058208@lngovernmentcollege.com</a></p>
        </div>
    </section>

    <footer>
        <p>&copy; 2025 chandrasekar J . All Rights Reserved.</p>
    </footer>
